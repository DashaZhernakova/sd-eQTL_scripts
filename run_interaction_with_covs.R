...
# 
# expr_fname <- "RS.gene_read_counts_BIOS_and_LLD_passQC.TMM.ProbesCentered.SamplesZTransformed.txt.gz"
# geno_fname <- "RS.eqtl_genotypes.filtered.dosages.txt.gz"
# gte_fname <- "RS_samples.txt"
# covar_fname <- "RS_sex_and_PCs.txt"
# 
